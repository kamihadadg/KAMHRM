...
export class SeederService {
    ...
    private positionsData = [
        // سطح 1 - مدیریت عالی
        { title: 'مدیر عامل', level: 1, department: 'مدیریت عالی', parentTitle: null, order: 1, isActive: true },

        // سطح 2 - معاونان و مدیران اصلی (تحت مدیر عامل)
        { title: 'معاون اجرایی', level: 2, department: 'مدیریت عالی', parentTitle: 'مدیر عامل', order: 2, isActive: true },
        { title: 'معاون مالی و اداری', level: 2, department: 'مدیریت عالی', parentTitle: 'مدیر عامل', order: 3, isActive: true },

        // سطح 3 - مدیران بخش‌ها (تحت معاونان)
        { title: 'مدیر منابع انسانی', level: 3, department: 'منابع انسانی', parentTitle: 'معاون اجرایی', order: 4, isActive: true },
        { title: 'مدیر مالی', level: 3, department: 'مالی', parentTitle: 'معاون مالی و اداری', order: 5, isActive: true },
        { title: 'مدیر فروش', level: 3, department: 'فروش', parentTitle: 'معاون اجرایی', order: 6, isActive: true },
        { title: 'مدیر بازاریابی', level: 3, department: 'بازاریابی', parentTitle: 'معاون اجرایی', order: 7, isActive: true },
        { title: 'مدیر تولید', level: 3, department: 'تولید', parentTitle: 'معاون اجرایی', order: 8, isActive: true },
        { title: 'مدیر IT', level: 3, department: 'فناوری اطلاعات', parentTitle: 'معاون اجرایی', order: 9, isActive: true },
        { title: 'مدیر اداری', level: 3, department: 'اداری', parentTitle: 'معاون مالی و اداری', order: 10, isActive: true },

        // سطح 4 - کارشناسان و سرپرستان (تحت مدیران بخش‌ها)
        { title: 'کارشناس منابع انسانی', level: 4, department: 'منابع انسانی', parentTitle: 'مدیر منابع انسانی', order: 11, isActive: true },
        { title: 'کارشناس استخدام', level: 4, department: 'منابع انسانی', parentTitle: 'مدیر منابع انسانی', order: 12, isActive: true },
        { title: 'حسابدار', level: 4, department: 'مالی', parentTitle: 'مدیر مالی', order: 13, isActive: true },
        { title: 'کارشناس مالی', level: 4, department: 'مالی', parentTitle: 'مدیر مالی', order: 14, isActive: true },
        { title: 'کارشناس فروش', level: 4, department: 'فروش', parentTitle: 'مدیر فروش', order: 15, isActive: true },
        { title: 'کارشناس پشتیبانی فروش', level: 4, department: 'فروش', parentTitle: 'مدیر فروش', order: 16, isActive: true },
        { title: 'کارشناس بازاریابی دیجیتال', level: 4, department: 'بازاریابی', parentTitle: 'مدیر بازاریابی', order: 17, isActive: true },
        { title: 'طراح گرافیک', level: 4, department: 'بازاریابی', parentTitle: 'مدیر بازاریابی', order: 18, isActive: true },
        { title: 'سرپرست تولید', level: 4, department: 'تولید', parentTitle: 'مدیر تولید', order: 19, isActive: true },
        { title: 'کارشناس کنترل کیفیت', level: 4, department: 'تولید', parentTitle: 'مدیر تولید', order: 20, isActive: true },
        { title: 'برنامه‌نویس ارشد', level: 4, department: 'فناوری اطلاعات', parentTitle: 'مدیر IT', order: 21, isActive: true },
        { title: 'مدیر پروژه', level: 4, department: 'فناوری اطلاعات', parentTitle: 'مدیر IT', order: 22, isActive: true },
        { title: 'منشی', level: 4, department: 'اداری', parentTitle: 'مدیر اداری', order: 23, isActive: true },
        { title: 'کارشناس اداری', level: 4, department: 'اداری', parentTitle: 'مدیر اداری', order: 24, isActive: true },

        // سطح 5 - کارمندان عملیاتی (تحت کارشناسان)
        { title: 'کارمند منابع انسانی', level: 5, department: 'منابع انسانی', parentTitle: 'کارشناس منابع انسانی', order: 25, isActive: true },
        { title: 'کارمند استخدام', level: 5, department: 'منابع انسانی', parentTitle: 'کارشناس استخدام', order: 26, isActive: true },
        { title: 'کارمند مالی', level: 5, department: 'مالی', parentTitle: 'حسابدار', order: 27, isActive: true },
        { title: 'کارمند حسابداری', level: 5, department: 'مالی', parentTitle: 'کارشناس مالی', order: 28, isActive: true },
        { title: 'نماینده فروش', level: 5, department: 'فروش', parentTitle: 'کارشناس فروش', order: 29, isActive: true },
        { title: 'کارشناس پشتیبانی', level: 5, department: 'فروش', parentTitle: 'کارشناس پشتیبانی فروش', order: 30, isActive: true },
        { title: 'کارشناس دیجیتال', level: 5, department: 'بازاریابی', parentTitle: 'کارشناس بازاریابی دیجیتال', order: 31, isActive: true },
        { title: 'طراح', level: 5, department: 'بازاریابی', parentTitle: 'طراح گرافیک', order: 32, isActive: true },
        { title: 'کارگر خط تولید', level: 5, department: 'تولید', parentTitle: 'سرپرست تولید', order: 33, isActive: true },
        { title: 'کارشناس QC', level: 5, department: 'تولید', parentTitle: 'کارشناس کنترل کیفیت', order: 34, isActive: true },
        { title: 'برنامه‌نویس', level: 5, department: 'فناوری اطلاعات', parentTitle: 'برنامه‌نویس ارشد', order: 35, isActive: true },
        { title: 'کارشناس IT', level: 5, department: 'فناوری اطلاعات', parentTitle: 'مدیر پروژه', order: 36, isActive: true },
        { title: 'کارمند اداری', level: 5, department: 'اداری', parentTitle: 'منشی', order: 37, isActive: true },
        { title: 'کارشناس بایگانی', level: 5, department: 'اداری', parentTitle: 'کارشناس اداری', order: 38, isActive: true },
    ];
    ...
    async clearTestData(): Promise<SeederResult> {
        ...
        try {
            ...
            // 4. پاک کردن کاربران (به جز ادمین)
            ...
            // 5. پاک کردن سمت‌ها (به جز سمت‌های سیستمی)
    ...
    async getSeederStats(): Promise<any> {
        ...
        return {
            ...
            evaluations,
            profiles,
            total: positions + users + goals + evaluations + profiles
        };
    }
}
